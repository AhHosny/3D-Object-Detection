...
if __name__ == '__main__':
    ...
    with torch.no_grad():
        for sample_idx in range(len(demo_dataset)):
            ...
            #write_credit(out_img, (80, 210), text_author='Cre: Ahmed Hosny', org_fps=(80, 250), fps=fps)
            write_credit(out_img, (80, 500), text_author='Cre: Ahmed Hosny', org_fps=(80, 540), fps=fps) #Ahosny
            if out_cap is None:
