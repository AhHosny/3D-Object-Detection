...
def parse_demo_configs():
    ...
    parser.add_argument('--foldername', type=str, default='demo', metavar='FN',
...
def write_credit(img, org_author=(500, 400), text_author='Cre: Ahmed Hosny', org_fps=(50, 1000), fps=None):
